        ...
        <div className="w-full flex md:flex-row flex-col-reverse relative bg-custom-blue justify-between items-center rounded-t-xl ">
          <div className="mt-8 ml-8">
            ...
            <div className="md:w-3/4 w-5/6 my-4 text-white text-sm">
              ...
              from various websites is gathered and presented in one convenient
              location. Whether you're seeking a new challenge or exploring
              career options, the intuitive search functionality makes it easy
              to find the perfect opportunity. Start your job search journey
              today and take the next step towards your dream career!
            </div>
          </div>
          <div className="circle rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 overflow-hidden"></div>
          <div className="h-auto w-full flex md:justify-end md:mr-8 ml-8">
            <img src={jobImage} alt="Banner" className="opacity-90 " />
          </div>
        </div>
